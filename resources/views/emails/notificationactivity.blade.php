...
<table class="email-container" style="width: 100%; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden; text-align: center; font-family: Arial, sans-serif; color: #333;">
    <tr>
        <td style="background-image: linear-gradient(to right, #7565e4, #56c496); color: white; padding: 10px;">
            <h1>Nova atividade adicionada</h1>
        </td>
    </tr>
    <tr>
        <td style="padding: 20px;">
            <p style="line-height: 1.6;">Olá!</p>
            <p>Uma nova foi criada para a sua equipa.</p>
            <p>Faz login na plataforma Teamster para ver mais informações.</p>
            <a href="http://161.35.200.213/participantauth" style="display: inline-block; text-decoration: none;">
                <button class="button" style="display: inline-block; width: auto; padding: 10px 20px; margin: 20px auto; background-color: #050505; color: white; text-decoration: none; border-radius: 5px; text-align: center; border: none; cursor: pointer;">Ir para o Teamster
                </button>
            </a>
